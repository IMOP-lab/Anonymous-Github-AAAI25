...
ROOT="./datasets/FeTA" # Relative path to the dataset
OUTPUT="./output/FeTA"
DATASET="FeTA"  # dataloader
NETWORKS="uC_3DUXNET" # You need to select the network you want to train here, please refer to ./model.py for details.
FINOUT=$OUTPUT/uC_3DUXNET
NUM_CLASS='8'  # You need to replace num_class with the number of segmentation categories for the specified dataset, including background.
